...
<template>
  <nav class="sm:hidden">
    <PanelMenu :model="menuItems">
      <template #item="slot">
        <div v-if="slot.item">
          <NuxtLink :to="slot.item.to" exact-active-class="!bg-white !text-slate-900" active-class="!bg-white !border-none" class="flex flex-row justify-between gap-2 p-4 rounded" @click="toggleMobileSidebar">
